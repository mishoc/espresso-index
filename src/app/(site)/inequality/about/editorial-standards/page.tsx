...
export default function Page() {
  return (
    <article className="prose-site mx-auto w-full max-w-[720px] px-6 py-10">
      ...
      <p>Each library entry carries an <code>is_contested</code> flag and, where one exists, a link to a <a href="/inequality/perspectives">Perspectives</a> page that gives each side its strongest evidence and ends with an explicit &ldquo;where the field stands&rdquo; that does not pick a winner. We would rather say &ldquo;unresolved&rdquo; than be confidently wrong.</p>
      ...
      <p>See <a href="/inequality/about/corrections">Corrections</a>. Errors are fixed in place and logged publicly.</p>
    </article>
  );
}
